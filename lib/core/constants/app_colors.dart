...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF0F766E); // Genoa 700 (Used for AppBars/Headers)
  static const Color primaryLight = Color(0xFFE6F6F4); // Green Light (Used for light accents/bubbles)
  ...
  static const Color darkInputFill = woodsmoke900; // #121212 (Slightly lighter than bg for inputs)
